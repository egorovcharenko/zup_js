// сборные товары
CompoundGoods = new Mongo.Collection('compound_goods');
...
ModerationTimes = new Mongo.Collection('moderation_times');

// nalogi
NalogiRashodi = new Mongo.Collection('nalogi_rashodi');
NalogiSums = new Mongo.Collection('nalogi_sums');
...
// Платежи в Апликс
AplixMutualSettlements = new Mongo.Collection('aplix_mutual_settlements');
AplixDeliveryCosts = new Mongo.Collection('aplix_delivery_costs');
