        ...
        while curDate <= endDate
          ...
          _.each result.data.details, (detail) ->
            if detail.type is "MutualSettlementDetailCalcCostShipping"
              ...
              AplixDeliveryCosts.upsert {orderName: detail.content.orderExternalNumber}, {$set: {packagePrice: packagePrice, weightTarif: weightTarif, insurance: insurance, weight: detail.content.postWeight, deliveryCostTotal: detail.content.deliveryCost - packagePrice, postLength: detail.content.postLength, postWidth: detail.content.postWidth, postHeight: detail.content.postHeight, postVolumeWeight: detail.content.postVolumeWeight, deliveryMethod: detail.content.deliveryMethod}}
